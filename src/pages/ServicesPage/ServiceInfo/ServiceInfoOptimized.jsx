...
const MediaGallery = ({ item, mobile }) => {
    ...
    if (!media.length) {
        return <img src={fallbackImage} alt={item?.title || ''} />;
    }
                    ...
                    <div className="service-main-right">
                        ...
                        <div className="service-main-right-group">
                            <p
                                className={
                                    isOpened
                                        ? 'service-main-right-desc-full'
                                        : 'service-main-right-desc'
                                }
                            >
                        ...
                        <div className="service-main-block">
                            <a className="service-phone" href={`tel:${selectedItem?.phone}`}>
                                <p>{selectedItem?.phone}</p>
                            </a>
                            <a className="service-phone" href={`mailto:${selectedItem?.email}`}>
                                <p>{selectedItem?.email}</p>
                            </a>
                            <a className="service-link" href={selectedItem?.site}>
                                <p>Перейти на сайт</p>
                            </a>
                        </div>
                    </div>
