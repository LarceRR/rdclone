...
// import GalleryItem from '../GalleryPreview/GalleryItem.jsx';
...
const ProductPageInner = ({ data }) => {
    return (
        <div className={'ProductPageInner'}>
            ...
            {/* {data.preview === 'gallery' ? <GalleryItem /> : <ProductSlider />} */}
            <div className={'videoContainer'}>
                <video
                    loop
                    autoPlay
                    src="https://ru.yougile.com/user-data/eeef3702-fe0e-4ef0-aa5c-e9bd68a1a34f/%D0%92%D0%B8%D0%B4%D0%B5%D0%BE%20WhatsApp%202025-01-07%20%D0%B2%2013.53.09_fa5fed38.mp4"
                    controls
